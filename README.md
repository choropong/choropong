...
- 📫 저와 연락하고 싶으시다면 <a href="https://discord.gg/qvSTBqyNEW">디스코드 서버</a> 또는 <a href="mailto:choropong@gmail.com" onclick="copyToClipboard()" title="클릭하면 메일 주소가 복사됩니다!">메일</a>로 연락해주세요! (≧∇≦)ﾉ
...
function copyToClipboard() {
  const email = "choropong@gmail.com";
  navigator.clipboard.writeText(email).then(() => {
    alert("메일 주소가 클립보드에 복사되었습니다: " + email);
  }).catch(err => {
